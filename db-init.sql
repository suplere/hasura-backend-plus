...
ALTER TABLE ONLY user_roles
  ADD CONSTRAINT user_roles_user_id_role_app_id_key UNIQUE (user_id, role, app_id);
...
CREATE TRIGGER set_public_apps_updated_at BEFORE UPDATE ON apps FOR EACH ROW EXECUTE PROCEDURE set_current_timestamp_updated_at();
